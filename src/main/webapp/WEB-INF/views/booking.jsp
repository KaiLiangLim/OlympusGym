...
<body>
	...
	<div class="text-boxx">
		<h2>Please Select Your Personal Training of Choice</h2>
		<form action="processPersonalTraining" method="post">
			<table>
				<tr>
					<th>Program ID</th>
					<th>Price</th>
				...
				<c:forEach items="${sessionScope.listOfPT }" var="personalTraining">
					<tr>
						<td><input type="checkbox" name="selectedPersonalTrainingId"
							value=${personalTraining.personalTrainingId }></td>
						<td>$${personalTraining.price }</td>
						<td>${personalTraining.trainer.trainerName }</td>
						<td>${personalTraining.categoryName }</td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${personalTraining.description }</td>

					</tr>
				</c:forEach>
			</table>
			<input type="submit" value="Click here to choose Date and Time" />
		</form>
